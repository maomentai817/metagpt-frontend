...
import ava from '@/assets/qianxun.jpg'
defineProps({
  type: {
    type: String,
    default: 'item'
...
<template>
  <div class="pro-item-container m-x-15 cp duration-300 m-b-20">
    <div class="pro-item-content h-250 f-c">
      ...
      >
        ...
        <div class="txt color-#b2b9bc p-t-8">新建模板</div>
      </div>
      <div class="item wh-full relative fd-col f-c" v-else>
        <div class="cover-img wh-120">
          <img :src="ava" alt="" class="wh-full" />
        </div>
        <div
          class="sort m-t-20 m-x-15 w-80% h-24 leading-24 overflow-hidden color-#fff bg-#27ba9b text-center relative"
        >
          <span class="fs-14 wh-full">{{ name }}</span>
        ...
        <div class="msk absolute wh-full top-0 left-0 opacity-0">
          <span class="animated wh-full f-c fd-col">
            ...
            <div class="txt color-#27ba9b m-t-8">查看模板</div>
          </span>
        </div>
      </div>
    </div>
