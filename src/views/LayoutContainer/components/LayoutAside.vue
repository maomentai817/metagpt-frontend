...
<template>
  <div class="aside-container wh-full">
    <el-menu
      ...
      @select="handleOpen"
    >
      <div class="aside-title text-center p-y-15 w-full f-c h-70">
        <span
          class="fs-24 fw-500 pl-8 text-overflow"
          id="title"
          :class="globalStore.isDark ? 'dark-mode' : 'light-mode'"
          v-show="!globalStore.isCollapse"
          >metagpt</span
        >
        <span v-show="globalStore.isCollapse" class="wh-full f-c">
          <svg class="wh-full p-l-25%">
            <path
              ...
              :fill="globalStore.isDark ? '#409eff' : '#27ba9b'"
            />
          </svg>
        </span>
      </div>
